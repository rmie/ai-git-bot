...
--
-- The "Default" configuration is created by DefaultWorkflowConfigurationInitializer
-- on application startup (idempotent). Existing bots are backfilled to that
-- default below so the new mandatory association does not break upgrades.
