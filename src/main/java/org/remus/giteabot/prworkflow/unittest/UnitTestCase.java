...
/**
 * One generated unit-test file inside a {@link UnitTestSuite}. The full file
...
public class UnitTestCase {
    ...
    /** Repository-relative path of the test file, e.g. {@code src/test/java/com/acme/FooTest.java}. */
    @Column(nullable = false, length = 1024)
    private String path;

    /** Optional human-readable title; may be {@code null}. */
    @Column(length = 512)
    ...
    private UnitTestCaseStatus lastStatus = UnitTestCaseStatus.PENDING;
